...
from robust_gymnasium import Env, logger
from robust_gymnasium.core import ActType, ObsType
...
try:
    ...
    raise gym.error.DependencyNotInstalled(
        'pygame is not installed, run `pip install "robust_gymnasium[classic_control]"`'
    ) from e
...
try:
    ...
    logger.warn('matplotlib is not installed, run `pip install "robust_gymnasium[other]"`')
...
def play(
    ...
    Example:
        >>> import robust_gymnasium as gym
        >>> import numpy as np
        >>> from robust_gymnasium.utils.play import play
        ...
        >>> from robust_gymnasium.utils.play import PlayPlot, play
    ...
    def __init__(
        ...
        if plt is None:
            raise DependencyNotInstalled(
                'matplotlib is not installed, run `pip install "robust_gymnasium[other]"`'
            )

...
from robust_gymnasium.utils import RecordConstructorArgs, seeding


if TYPE_CHECKING:
    from robust_gymnasium.envs.registration import EnvSpec, WrapperSpec
...
class Env(Generic[ObsType, ActType]):
    r"""The main robust_gymnasium class for implementing Reinforcement Learning Agents environments.
    ...
    - :attr:`spec` - An environment spec that contains the information used to initialize the environment from :meth:`robust_gymnasium.make`
    ...
    .. seealso:: For modifying or extending environments use the :class:`robust_gymnasium.Wrapper` class
    ...
    def render(self) -> RenderFrame | list[RenderFrame] | None:
        ...
        `robust_gymnasium.make` which automatically applies a wrapper to collect rendered frames.
        ...
        - "rgb_array_list" and "ansi_list": List based version of render modes are possible (except Human) through the
          wrapper, :py:class:`robust_gymnasium.wrappers.RenderCollection` that is automatically applied during ``robust_gymnasium.make(..., render_mode="rgb_array_list")``.
        ...
        .. versionchanged:: 0.25.0
            ...
            in the environment initialised, i.e., ``robust_gymnasium.make("CartPole-v1", render_mode="human")``
        """
        raise NotImplementedError
    ...
    def unwrapped(self) -> Env[ObsType, ActType]:
        ...
        Returns:
            Env: The base non-wrapped :class:`robust_gymnasium.Env` instance
        """
        return self
...
class Wrapper(
    ...
    """Wraps a :class:`robust_gymnasium.Env` to allow a modular transformation of the :meth:`step` and :meth:`reset` methods.
    ...
    def unwrapped(self) -> Env[ObsType, ActType]:
        ...
        This will be the bare :class:`robust_gymnasium.Env` environment, underneath all layers of wrappers.
        """
    ...
    def spec(self) -> EnvSpec | None:
        ...
        if env_spec is not None:
            ...
            from robust_gymnasium.envs.registration import WrapperSpec
...
class ActionWrapper(Wrapper[ObsType, WrapperActType, ObsType, ActType]):
    ...
    Among others, robust_gymnasium provides the action wrappers :class:`robust_gymnasium.wrappers.ClipAction` and
    :class:`robust_gymnasium.wrappers.RescaleAction` for clipping and rescaling actions.
    """

...
if _MUJOCO_GL not in ("disable", "disabled", "off", "false", "0"):
    ...
    if _SYSTEM == "Linux" and _MUJOCO_GL == "osmesa":
        from robust_gymnasium.envs.robosuite.renderers.context.osmesa_context import OSMesaGLContext as GLContext
    elif _SYSTEM == "Linux" and _MUJOCO_GL == "egl":
        from robust_gymnasium.envs.robosuite.renderers.context.egl_context import EGLGLContext as GLContext
    else:
        from robust_gymnasium.envs.robosuite.renderers.context.glfw_context import GLFWGLContext as GLContext

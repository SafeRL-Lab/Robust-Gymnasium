...
FORMAT_STR = {"file": "[robust_gymnasium.envs.robosuite %(levelname)s - %(asctime)s] ", "console": "[robust_gymnasium.envs.robosuite %(levelname)s] "}
...
class DefaultLogger:
    """Default logger class in robust_gymnasium.envs.robosuite codebase."""

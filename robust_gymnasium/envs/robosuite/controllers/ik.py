...
from robust_gymnasium.envs.robosuite.controllers.joint_vel import JointVelocityController
from robust_gymnasium.envs.robosuite.utils.control_utils import *
...
class InverseKinematicsController(JointVelocityController):
    ...
    def setup_inverse_kinematics(self, load_urdf=True):
        ...
        self.robot_urdf = pjoin(
            os.path.join(robust_gymnasium.envs.robosuite.models.assets_root, "bullet_data"),
        ...
        from robust_gymnasium.envs.robosuite.controllers import get_pybullet_server

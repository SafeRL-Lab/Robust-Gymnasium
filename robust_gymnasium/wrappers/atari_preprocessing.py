...
from robust_gymnasium.core import WrapperActType, WrapperObsType
...
class AtariPreprocessing(gym.Wrapper, gym.utils.RecordConstructorArgs):
    ...
    For frame stacking use :class:`robust_gymnasium.wrappers.FrameStackObservation`.
    ...
    def __init__(
        ...
        try:
            ...
            raise gym.error.DependencyNotInstalled(
                'opencv-python package not installed, run `pip install "robust_gymnasium[other]"` to get dependencies for atari'
            )

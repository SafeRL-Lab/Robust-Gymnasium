...
from robust_gymnasium.envs.robosuite import load_controller_config
from robust_gymnasium.envs.robosuite.utils.input_utils import input2action
from robust_gymnasium.envs.robosuite.utils.observables import Observable, create_gaussian_noise_corrupter, create_uniform_sampled_delayer
from robust_gymnasium.envs.robosuite.wrappers import VisualizationWrapper
...
if __name__ == "__main__":
    ...
    if args.device == "keyboard":
        from robust_gymnasium.envs.robosuite.devices import Keyboard

        device = Keyboard(pos_sensitivity=args.pos_sensitivity, rot_sensitivity=args.rot_sensitivity)
    elif args.device == "spacemouse":
        from robust_gymnasium.envs.robosuite.devices import SpaceMouse
